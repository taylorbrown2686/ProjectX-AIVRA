...
public class UltimateJoystickReadmeEditor : Editor
{
	...
	void VersionHistory ()
	{
		...
		EditorGUILayout.LabelField( "  • Fixed an issue with the README editor.", paragraphStyle );
		EditorGUILayout.LabelField( "  • Fixed an issue where the Ultimate Joystick would return incorrect values when using the DisableJoystick function.", paragraphStyle );
