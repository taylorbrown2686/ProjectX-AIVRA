...
public class SquirrelCameraScript : MonoBehaviour
{
    public GameObject target;
    public float turnSpeed = .2f;
    public GameObject squirrelCamera;
    ...
    void Update()
    {
        ...
        squirrelCamera.transform.localPosition = new Vector3(0f, cameraDistance, -2f * cameraDistance);
    }
